...
scenario["func-db-mig-show-tables"]=["migration list","migration table","mig table","mig list","migration"];
scenario["func-db-mig-hide-tables"]=["hide migration list","delete migration table","hide mig list","hide mig table"];
